...
type MyWebAuthnRegisterPageProps = {
    kcContext: Extract<KcContext, { pageId: "webauthn-register.ftl" }>;
};

export default function MyWebAuthnRegisterPage(props: MyWebAuthnRegisterPageProps) {
                ...
                <div className="backdrop-blur-xl bg-glass-backdrop border border-glass-border rounded-2xl shadow-glass p-8">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-white/70 text-sm">
                            Configure seu dispositivo para login seguro
                        </p>
                    </div>
                    ...
                    <div className="mb-6 p-4 bg-glass-primary/20 border border-glass-border rounded-xl">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="text-white/80 text-sm">
                                <p className="mb-2">Para configurar a autenticação biométrica:</p>
                                <ol className="list-decimal list-inside space-y-1 text-white/70">
                                    <li>Certifique-se de que seu dispositivo suporta WebAuthn</li>
                                    <li>Clique em "Registrar dispositivo"</li>
